  ...
  <div class = "col-demo">
    ...
    <div class = "width">
      <cu-alert type = 'warning' title = '注意事项：'>
        UI库单独为组件设计了cu-layout cu-row,可以配合cu-col灵活使用，具体使用请看demo
      </cu-alert>
    </div>
    <h3>基础用法</h3>
    ...
    <code-source :showFlag = false :targetCode = 'example3'>
      <div class = "container">
        <cu-layout>
          <cu-row style = 'height: 300px' class = 'row' direction = 'column' justify = 'center' align = 'middle'>
...
import { example, example1, example2, example3, layoutComponent, rowComponent, colComponent } from './col-data'
