<template>
  <div class = "button-demo">
    ...
    <code-source :targetCode = 'example1' :showFlag = false>
      <cu-button class = 'margin-right' v-for = "item in ['medium', 'small', 'mini', 'big']" :key = 'item'
                 :size = 'item'>{{ item }}
      </cu-button>
    </code-source>
    <h3>不同状态</h3>
    <code-source :targetCode = 'example2' :showFlag = false>
      <cu-button class = 'margin-right' v-for = "item in ['primary', 'success', 'warning', 'danger', 'info', 'text']"
                 :type = 'item'
                 :key = 'item'>{{ item }}
      </cu-button>
    </code-source>
    ...
    <code-source :targetCode = 'example6' :showFlag = false>
      <cu-button class = 'margin-right' v-for = "item in ['edit', 'search', 'close', 'date']" :key = "item"
                 :icon = 'item'>带有图标按钮
      </cu-button>
    </code-source>
...
import { example, example1, example2, example3, example4, example5, example6, componentProps } from './button-data'
