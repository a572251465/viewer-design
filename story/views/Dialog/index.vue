<template>
  <div class = "dialog-demo">
    ...
    <code-source :showFlag = false :targetCode = 'example3'>
      ...
      <cu-dialog v-model = 'showFlag3' :closeOnPressEscape = true :closeOnClickModel = true>
    ...
    <code-source :showFlag = false :targetCode = 'example4'>
      ...
      <cu-dialog v-model = 'showFlag4' :closeOnPressEscape = true :closeOnClickModel = true :visibleHeader = false
                 :visibleFooter = false>
    ...
    <h3>强大的指令系统</h3>
    <p>dialog中除了提供内容性弹框，同时提供了通过指令形式调用的弹框，为用户更好的交互提供了方便</p>
    <code-source :showFlag = false :targetCode = 'example7'>
      <p>确定提示框</p>
      <cu-alert style = 'margin-top: 10px' :type = 'item' v-for = "item in ['info', 'success', 'warning', 'danger']"
                :key = 'item'>
...
export default defineComponent({
  ...
  setup() {
    ...
    const showFlag4 = ref<string>(false)
